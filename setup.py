...
setuptools.setup(
    ...
    download_url="https://github.com/Tanvir223/TabularDataInvestigation/archive/refs/tags/0.0.1.tar.gz",
    ...
    classifiers=[
        ...
        'Intended Audience :: Data Scientist, Data Engineer, Data Analyst, ML Engineer, Developers',
